...
def fetch_subscriptions(youtube):
    ...
    while True:
        ...
        for item in response.get("items", []):
            ...
            if channel_id:
                subs.append({"title": title, "channel_id": channel_id})
...
def parse_args():
    ...
    parser.add_argument(
        "--output-html",
        default="subscription_marketcap_treemap.html",
    ...
    parser.add_argument("--title", default="YouTube Subscriptions - Market Cap Treemap", help="Chart title")
