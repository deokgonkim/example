...
# aws s3 sync ./docs/ s3://doc.dgkim.net/example-component-installable/ --acl public-read
aws s3 sync ./docs/ s3://doc.dgkim.net/example-component-installable/
...
aws cloudfront create-invalidation --distribution-id $CF_DISTRIBUTION_ID --paths "/example-component-installable/*"
