/* from: https://github.com/adafruit/Adafruit-PN532/blob/master/examples/ntag2xx_updatendef/ntag2xx_updatendef.ino */
...
// #define PN532_SS   (4)
// #define PN532_MISO (5)
#define PN532_SCK  D5  // SCK (SCL) 14
#define PN532_MISO D6  // MISO 12
#define PN532_MOSI D7  // MOSI 13
#define PN532_SS   D1  // SS (SDA) 5 
...
*/
// For a http://www. url:
uint8_t ndefprefix = NDEF_URIPREFIX_HTTPS_WWWDOT;
char * url = "dgkim.net/";
